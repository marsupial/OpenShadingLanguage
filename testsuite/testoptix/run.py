...
command += testoptix("-r 1 1 test_userdata_string.xml dummy.exr")
command += testoptix("-r 512 512 test_texture.xml test_texture.exr")
command += testoptix("-r 512 512 test_spline.xml test_spline.exr")
